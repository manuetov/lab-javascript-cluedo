...
function selectRandom(cardArr) {
  let numRandom = Math.random() * cardArr.length
  let indexRandom = Math.floor(numRandom)
  // console.log(indexRandom)
  // console.log( cardArr )
  let randomCard = cardArr[indexRandom]
...
function revealMystery(guilty) {
  console.log(`${guilty.firstName} ${guilty.lastName} killed Mr. Boddy using the ${guilty.weapon} in the ${guilty.room} `)
}
